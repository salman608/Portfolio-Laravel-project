...
@section('content')
     ...
     <div class="container-fluid">
            <div class="block-header">
                <h2>
                    <a href="{{ route('about.create') }}" class="btn btn-primary waves-effect">
                                      ...
                                      @foreach ($abouts  as $key=>$about)
                                        <tr>
                                             ...
                                             <a href="{{ route('about.edit',$about->id) }}" class="btn btn-info">
                                              ...
                                              <button type="button" class="btn btn-danger" onclick="deleteAbout({{ $about->id }})">
